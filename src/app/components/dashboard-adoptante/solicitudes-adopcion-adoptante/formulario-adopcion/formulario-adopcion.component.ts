...
export class FormularioAdopcionComponent implements OnInit {
  ...
  onEnviarSolicitud(form: NgForm){
    ...
    const informacionFamiliar : InformacionFamiliar={numAdultos: form.value.numAdultos,numNiños: form.value.numNiños,edadesAdultos: form.value.edadesAdultos,
    ...
    const informacionRelacionada: InformacionRelacionada = {tiempoEnCasaHoras: form.value.tiempoEnCasaHoras,horaRegresoCasa: form.value.horaRegresoCasa,lugarViviendaDeMascota: form.value.lugarViviendaDeMascota,
      patioInteriorJugar: form.value.patioInteriorJugar, veterinarioGastos: form.value.veterinarioGastos,mascotaAnterior: form.value.mascotaAnterior,conoceCuidadosMascota: form.value.conoceCuidadosMascota,veterinarioDeConfianza: form.value.veterinarioDeConfianza,
      ...
      tiempoAdaptacionAnimal: form.value.tiempoAdaptacionAnimal, asumirGastosAnimal: form.value.asumirGastosAnimal,adoptanteAlternativoAusencia: form.value.adoptanteAlternativoAusencia,permisionTenenciaAnimales: form.value.permisionTenenciaAnimales}
    const animalAdopcion: EntidadAnimal={nombre: form.value.nombre,edad: form.value.edad,raza: form.value.raza,sexo: form.value.sexo,tamano: form.value.tamano,color_ojos: form.value.color_ojos,tipo_pelaje: form.value.tipo_pelaje,situacion: form.value.situacion,desparasitado: form.value.desparasitado,
      ultima_vac: form.value.ultima_vac,descripcion: form.value.descripcion,esquema_vac: form.value.esquema_vac,urlImg: form.value.urlImg,tipo_animal: form.value.tipo_animal, idPapa: form.value.tipo_doc, enAdopcion: true};
